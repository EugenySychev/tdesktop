...
if (DESKTOP_APP_DISABLE_SPELLCHECK)
    target_compile_definitions(TG_Connect PRIVATE TDESKTOP_DISABLE_SPELLCHECK)
else()
    target_link_libraries(TG_Connect PRIVATE desktop-app::lib_spellcheck)
endif()

if (DESKTOP_APP_DISABLE_AUTOUPDATE)
    target_compile_definitions(TG_Connect PRIVATE TDESKTOP_DISABLE_AUTOUPDATE)
endif()

if (DESKTOP_APP_SPECIAL_TARGET)
    target_compile_definitions(TG_Connect PRIVATE TDESKTOP_ALLOW_CLOSED_ALPHA)
endif()

if (NOT TDESKTOP_LAUNCHER_BASENAME)
    set(TDESKTOP_LAUNCHER_BASENAME "telegramdesktop")
endif()
target_compile_definitions(TG_Connect PRIVATE TDESKTOP_LAUNCHER_BASENAME=${TDESKTOP_LAUNCHER_BASENAME})
